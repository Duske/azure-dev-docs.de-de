...
In diesem Tutorial wird veranschaulicht, wie Sie in Azure ein lokales Netzwerk implementieren. Sie können das Beispielnetzwerk auch durch ein privates virtuelles Netzwerk ersetzen. Passen Sie hierfür die Subnetz-IP-Adressen so an, dass sie Ihrer Umgebung entsprechen.
...
> [Erstellen eines virtuellen Hub-Netzwerks mit Terraform in Azure](./hub-spoke-hub-network.md)