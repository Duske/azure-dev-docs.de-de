...
ms.locfileid: "90831966"
---
# <a name="use-spring-data-jpa-with-azure-sql-database"></a>Verwenden der Spring Data-JPA mit Azure SQL-Datenbank

In diesem Thema wird die Erstellung einer Beispielanwendung veranschaulicht, die [Spring Data-JPA](https://spring.io/projects/spring-data-jpa) verwendet, um Informationen in [Azure SQL-Datenbank](/azure/sql-database/) zu speichern bzw. daraus abzurufen.
