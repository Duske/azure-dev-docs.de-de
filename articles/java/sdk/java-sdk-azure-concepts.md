...
Verwenden Sie die `listByResourceGroup(String groupname)`-Methode, um die zurückgegebene Liste auf eine bestimmte [Azure-Ressourcengruppe](/azure/azure-resource-manager/resource-group-overview#resource-groups) einzugrenzen.  
