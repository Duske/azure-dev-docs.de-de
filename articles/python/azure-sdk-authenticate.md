...
## <a name="authenticate-with-a-json-file"></a><a name="mgmt-auth-file"></a>Authentifizieren mit einer JSON-Datei
...
## <a name="authenticate-with-token-credentials"></a><a name="mgmt-auth-token"></a>Authentifizieren mit Tokenanmeldeinformationen
...
### <a name="authenticate-with-token-credentials-deprecated"></a><a name="mgmt-auth-legacy"></a>Authentifizieren mit Tokenanmeldeinformationen (veraltet)
...
## <a name="authenticate-with-azure-managed-identities"></a><a name="mgmt-auth-msi"></a>Authentifizieren mit verwalteten Azure-Identitäten
...
## <a name="cli-based-authentication-development-purposes-only"></a><a name="mgmt-auth-cli"></a>CLI-basierte Authentifizierung (nur für Entwicklungszwecke)
