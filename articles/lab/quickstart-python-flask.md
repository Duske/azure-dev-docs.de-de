...
description: Führen Sie erste Schritte mit Azure App Service aus, und stellen Sie Ihre erste Python-App in einem Linux-Container in App Service bereit.
ms.topic: quickstart
ms.date: 09/22/2020
...
In diesem Schnellstart stellen Sie eine Python-Web-App für [App Service für Linux](/azure/app-service/overview#app-service-on-linux) bereit. Dies ist der überaus skalierbare Webhostingdienst von Azure mit automatisiertem Patchen. Sie verwenden die lokale [Azure-Befehlszeilenschnittstelle (CLI)](/cli/azure/install-azure-cli) auf einem Macintosh-, Linux- oder Windows-Computer, um ein Beispiel mit dem Flask- oder Django-Framework bereitzustellen. Die Web-App, die Sie konfigurieren, nutzt einen kostenlosen App-Service-Tarif, sodass Ihnen im Laufe dieses Artikels keine Kosten entstehen.
...
## <a name="2-clone-the-sample"></a>2. Klonen des Beispiels
...
## <a name="3-run-the-sample"></a>3. Ausführen des Beispiels
...
## <a name="4-deploy-the-sample"></a>4. Bereitstellen des Beispiels
...
- Wird der Befehl `az` nicht erkannt, sollten Sie sich vergewissern, dass die Azure CLI wie unter [Einrichten der anfänglichen Umgebung](#setup) beschrieben installiert wurde.
...
## <a name="5-browse-to-the-app"></a>5. Navigieren zur App
...
## <a name="6-redeploy-updates"></a>6. Erneutes Bereitstellen von Updates
...
## <a name="7-stream-logs"></a>7. Streaming von Protokollen
...
## <a name="8-manage-the-azure-app"></a>8. Verwalten der Azure-App
