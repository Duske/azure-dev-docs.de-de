...
6. Wählen Sie eine der folgenden Optionen:
   ...
   * **New log in credentials** (Neue Anmeldeinformationen): Erstellen Sie einen neuen Satz von Anmeldeinformationen. Gehen Sie bei Auswahl dieser Option wie folgt vor:
     ...
     * **Import from directory** (Aus Verzeichnis importieren): Gibt ein Verzeichnis an, das zuvor gespeicherte TLS-Einstellungen enthält. Das Verzeichnis muss die folgenden sechs Dateien enthalten:
         ...
         * *server.pem* und *server-key.pem*: Enthalten das Clientzertifikat und den öffentlichen Schlüssel für die TLS-Authentifizierung.
...
3. Klicken Sie zum Hinzufügen eines Artefakts auf das grüne Pluszeichen ( **+** ) und dann auf **Webanwendung: Archiv**.
   ...
   ![Der Befehl „Webanwendung: Archiv“][ART02]
