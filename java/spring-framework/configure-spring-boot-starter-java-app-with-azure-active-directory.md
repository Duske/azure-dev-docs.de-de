...
2. Wählen Sie unter **Name** den Namen Ihrer Anwendung aus, geben Sie für die http://localhost:8080 Anmelde-URL**den Wert** an, und klicken Sie anschließend auf **Erstellen**.
