...
* [Azure SQL-Datenbank](https://docs.microsoft.com/azure/sql-database/): Wenn Sie eine Anwendung in die Cloud migrieren möchten, die bereits SQL Server verwendet, bietet sich natürlich Azure SQL-Datenbank als Ausgangspunkt an. Informationen zu den ersten Schritten finden Sie unter [Tutorial: Erstellen einer ASP.NET-App in Azure mit SQL-Datenbank](https://docs.microsoft.com/azure/app-service/app-service-web-tutorial-dotnet-sqldatabase).
...
* [Azure Blob Storage](https://docs.microsoft.com/azure/storage/): Azure Blob Storage ist für das Speichern und Abrufen großer binärer Objekte wie Bilder, Dateien und Streams optimiert. Objektspeicher ermöglichen die Verwaltung extrem großer Mengen unstrukturierter Daten. Informationen zu den ersten Schritten finden Sie unter [Schnellstart: Erstellen eines Blobs im Objektspeicher mithilfe von .NET](https://docs.microsoft.com/azure/storage/blobs/storage-quickstart-blobs-dotnet).
